# 💻 Módulo Portugol — Praticando Lógica de Programação

Este diretório reúne todos os exercícios e algoritmos desenvolvidos em **Portugol**, com foco na construção de raciocínio lógico, fixação de estruturas fundamentais de programação e análise de fluxo de controle.

Os exercícios foram inicialmente praticados no **Portugol Studio** e posteriormente desenvolvidos/gerenciados no **Visual Studio Code (VS Code)**.

---

## 📁 Estrutura de Diretórios

A divisão do módulo segue a evolução conceitual do aprendizado:
...
1. 📂 EstruturasSequenciais/

Exercícios de execução linear (passo a passo sem desvios):

Declaração e tipagem de variáveis (inteiro, real, cadeia, caracter, logico)
